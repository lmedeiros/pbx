...
function load_values() {
    if (isset($_GET['id']) && $_GET['id'] != "") {
        $query = "SELECT * FROM pbx_route_incoming WHERE pbx_route_incoming_id = {$_GET['id']}";
...
//new Field($type, $title, $name, $default_value, $query, $helper, $size, $required)
    $fields = array(
        ...
        new Field("combo", "Campanha", "pbx_campaign_id", $record['pbx_campaign_id'], "SELECT * FROM pbx_campaign", "Campanha da Rota de entrada", 3, true, "pbx_campaign_id", "description", false),
