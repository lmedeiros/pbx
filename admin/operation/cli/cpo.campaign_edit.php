<?php
    ...
    $back_operation_id = 116;

    function load_values() {
        if (isset($_GET['id']) && $_GET['id'] != "") {
            $query = "SELECT * FROM pbx_campaign WHERE pbx_campaign_id = {$_SESSION[session_key]}";
	...
	new Field("hidden", "", "campaign_id", $_SESSION[session_key], "", "", 0, true)
    );
